...
{
    public class PutAlunoValidator : AbstractValidator<PutAlunoDto>
    {
        public PutAlunoValidator()
        {
            RuleFor(x => x.Nome)
              .NotNull()
        ...
        private bool PasswordValidator(PutAlunoDto putAlunoDto)
        {
            return putAlunoDto.Senha == putAlunoDto.ConfirmarSenha;
        }
    }
}